...
async def crawl_befood_restaurants(page=1, limit=12):
    ...
    headers = {
        ...
        'app_version': '11310',
        'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjowLCJhdWQiOiJndWVzdCIsImV4cCI6MTc2MjQ5MDA4NSwiaWF0IjoxNzYyNDAzNjg1LCJpc3MiOiJiZS1kZWxpdmVyeS1nYXRld2F5In0.8Q0mdula1CRYoXWnntYt9tWRUMDFbnFtq3XVG7GgP88',
